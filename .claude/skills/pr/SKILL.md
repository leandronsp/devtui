...
Derive the branch name from the commit history or changes (e.g., `feat/add-tag-filtering`).
...
### 6a. If NO existing PR - Create draft PR
...
### 6b. If PR already exists - Update description
